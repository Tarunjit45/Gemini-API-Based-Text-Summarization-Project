...
[![GitHub License](https://img.shields.io/github/license/Tarunjit45/Gemini-API-Based-Text-Summarization-Project?style=flat-square)](LICENSE)
[![CI / Quality Check](https://github.com/Tarunjit45/Gemini-API-Based-Text-Summarization-Project/actions/workflows/ci.yml/badge.svg)](https://github.com/Tarunjit45/Gemini-API-Based-Text-Summarization-Project/actions)
[![Language](https://img.shields.io/badge/Language-Python-blue?style=flat-square)](https://github.com/Tarunjit45/Gemini-API-Based-Text-Summarization-Project)
...
```bash
git clone https://github.com/Tarunjit45/Gemini-API-Based-Text-Summarization-Project.git
cd Gemini-API-Based-Text-Summarization-Project
```
